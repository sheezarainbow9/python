# Um cliente irá solicitar um empréstimo ao banco.
# Se o valor do empréstimo for menor ou igual a 50 % do seu salário,
# então o empréstimo será aprovado. Senão, se o valor do empréstimo
# for menor ou igual a 75 % do salário a situação ficará em análise.
